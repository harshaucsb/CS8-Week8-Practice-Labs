...
test_params = [
    ("wanda@hotmail.com"),
    ("wanda_245@hotmail.com"),
    ("wanda"),
    (""),
    (1)
    #("wanda@hotmail.com@invalid") # maybe too difficult?
]

max_score = len(test_params)

function_name = "extract_domain" # TODO

# TODO:  name the class according to the function name being tested
class ExtractDomain_Test(BaseClass):
    @partial_credit(max_score)
    @visibility('visible')
    def test1(self, set_score=None):
        """extract_list(email_address)""" # TODO
